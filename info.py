...
BOT_TOKEN = environ.get('BOT_TOKEN', "7782547428:AAECJRg65iRFW7O2pifVAMJyfz--N5bo4_I")

# Bot settings
CACHE_TIME = int(environ.get('CACHE_TIME', 300))
USE_CAPTION_FILTER = bool(environ.get('USE_CAPTION_FILTER', True))

PICS = (environ.get('PICS', 'https://envs.sh/Ypu.jpg https://envs.sh/5fw.jpg https://envs.sh/5fP.jpg https://envs.sh/5fb.jpg https://envs.sh/5fi.jpg')).split() #SAMPLE PIC
NOR_IMG = environ.get("NOR_IMG", "https://envs.sh/5fi.jpge")
MELCOW_VID = environ.get("MELCOW_VID", "https://envs.sh/5fb.jpg")
SPELL_IMG = environ.get("SPELL_IMG", "https://envs.sh/5fw.jpg")
SUBSCRIPTION = (environ.get('SUBSCRIPTION', 'https://envs.sh/5fi.jpg'))
CODE = (environ.get('CODE', 'https://envs.sh/5fb.jpg'))
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002245890779') #Channel / Group Id for force sub ( make sure bot is admin )
...
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Vasu2444:vasu2412@cluster0.b2cug.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
