...
async def start(client, message):
    ...
    if data.startswith("sendfiles"):
        ...
        for file in files:
            ...
            filesarr.append(msg)
        k = await client.send_message(chat_id = message.from_user.id, text=f"<b>❗️ <u>ɪᴍᴘᴏʀᴛᴀɴᴛ</u> ❗️</b>\n\n<b>ᴛʜᴇꜱᴇ ᴠɪᴅᴇᴏꜱ / ꜰɪʟᴇꜱ ᴡɪʟʟ ʙᴇ ᴅᴇʟᴇᴛᴇᴅ ɪɴ</b> <b><u>10 ᴍɪɴᴜᴛᴇꜱ</u> </b><b>(ᴅᴜᴇ ᴛᴏ ᴄᴏᴘʏʀɪɢʜᴛ ɪꜱꜱᴜᴇꜱ).</b>\n\n<b><i>📌 ᴘʟᴇᴀꜱᴇ ꜰᴏʀᴡᴀʀᴅ ᴛʜᴇꜱᴇ ᴠɪᴅᴇᴏꜱ / ꜰɪʟᴇꜱ ᴛᴏ ꜱᴏᴍᴇᴡʜᴇʀᴇ ᴇʟꜱᴇ ᴀɴᴅ ꜱᴛᴀʀᴛ ᴅᴏᴡɴʟᴏᴀᴅɪɴɢ ᴛʜᴇʀᴇ. 𝐉𝐎𝐈𝐍 𝐏𝐑𝐄𝐌𝐈𝐔𝐌 𝐂𝐇𝐀𝐍𝐍𝐄𝐋 𝐅𝐎𝐑 𝐀𝐋𝐋 𝐋𝐄𝐓𝐄𝐒𝐓 𝐌𝐎𝐕𝐈𝐄𝐒 𝐃𝐈𝐑𝐄𝐂𝐓 𝐎𝐍 𝐒𝐀𝐌𝐄 𝐃𝐀𝐘.... 𝐈𝐍 𝐉𝐔𝐒𝐓 𝟓𝟎 𝐑𝐒 𝐏𝐄𝐑 𝐌𝐎𝐍𝐓𝐇.. 𝐂𝐎𝐍𝐓𝐄𝐂𝐓 𝐀𝐃𝐌𝐈𝐍 𝐅𝐎𝐑 𝐌𝐎𝐑𝐄 𝐈𝐍𝐅𝐎 - @𝐢𝐦𝐯𝐚𝐬𝐮𝐩𝐚𝐫𝐞𝐞𝐤
</i></b>")
        await asyncio.sleep(600)
        for x in filesarr:
            await x.delete()
    ...
    if not files_:
        ...
        try:
            ...
            k = await client.send_message(chat_id = message.from_user.id, text=f"<b>❗️ <u>ɪᴍᴘᴏʀᴛᴀɴᴛ</u> ❗️</b>\n\n<b>ᴛʜɪꜱ ᴠɪᴅᴇᴏ / ꜰɪʟᴇ ᴡɪʟʟ ʙᴇ ᴅᴇʟᴇᴛᴇᴅ ɪɴ</b> <b><u>10 ᴍɪɴᴜᴛᴇꜱ</u> </b><b>(ᴅᴜᴇ ᴛᴏ ᴄᴏᴘʏʀɪɢʜᴛ ɪꜱꜱᴜᴇꜱ).</b>\n\n<b><i>📌 ᴘʟᴇᴀꜱᴇ ꜰᴏʀᴡᴀʀᴅ ᴛʜɪꜱ ᴠɪᴅᴇᴏ / ꜰɪʟᴇ ᴛᴏ ꜱᴏᴍᴇᴡʜᴇʀᴇ ᴇʟꜱᴇ ᴀɴᴅ ꜱᴛᴀʀᴛ ᴅᴏᴡɴʟᴏᴀᴅɪɴɢ ᴛʜᴇʀᴇ. 𝐉𝐎𝐈𝐍 𝐏𝐑𝐄𝐌𝐈𝐔𝐌 𝐂𝐇𝐀𝐍𝐍𝐄𝐋 𝐅𝐎𝐑 𝐀𝐋𝐋 𝐋𝐄𝐓𝐄𝐒𝐓 𝐌𝐎𝐕𝐈𝐄𝐒 𝐃𝐈𝐑𝐄𝐂𝐓 𝐎𝐍 𝐒𝐀𝐌𝐄 𝐃𝐀𝐘.... 𝐈𝐍 𝐉𝐔𝐒𝐓 𝟓𝟎 𝐑𝐒 𝐏𝐄𝐑 𝐌𝐎𝐍𝐓𝐇.. 𝐂𝐎𝐍𝐓𝐄𝐂𝐓 𝐀𝐃𝐌𝐈𝐍 𝐅𝐎𝐑 𝐌𝐎𝐑𝐄 𝐈𝐍𝐅𝐎 - @𝐢𝐦𝐯𝐚𝐬𝐮𝐩𝐚𝐫𝐞𝐞𝐤
</i></b>")
            await asyncio.sleep(600)
            await msg.delete()
