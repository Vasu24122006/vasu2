...
async def start(client, message):
    ...
    if data.startswith("sendfiles"):
        ...
        for file in files:
            ...
            filesarr.append(msg)
        k = await client.send_message(chat_id = message.from_user.id, text=f"<b>❗️ <u>ɪᴍᴘᴏʀᴛᴀɴᴛ</u> ❗️</b>\n\n<b>ᴛʜᴇꜱᴇ ᴠɪᴅᴇᴏꜱ / ꜰɪʟᴇꜱ ᴡɪʟʟ ʙᴇ ᴅᴇʟᴇᴛᴇᴅ ɪɴ</b> <b><u>10 ᴍɪɴᴜᴛᴇꜱ</u> </b><b>(ᴅᴜᴇ ᴛᴏ ᴄᴏᴘʏʀɪɢʜᴛ ɪꜱꜱᴜᴇꜱ).</b>\n\n<b><i>📌 ᴘʟᴇᴀꜱᴇ ꜰᴏʀᴡᴀʀᴅ ᴛʜᴇꜱᴇ ᴠɪᴅᴇᴏꜱ / ꜰɪʟᴇꜱ ᴛᴏ ꜱᴏᴍᴇᴡʜᴇʀᴇ ᴇʟꜱᴇ ᴀɴᴅ ꜱᴛᴀʀᴛ ᴅᴏᴡɴʟᴏᴀᴅɪɴɢ ᴛʜᴇʀᴇ.</b>\n\n<b><i>📌 ᴊᴏɪɴ ᴏᴜʀ ᴘʀᴇᴍɪᴜᴍ ᴄʜᴀɴɴᴇʟ ɪɴ ᴊᴜsᴛ 𝟻𝟶ʀs ᴘᴇʀ ᴍᴏɴᴛʜ ᴛᴏ ɢᴇᴛ ᴀʟʟ ᴍᴏᴠɪᴇs ᴏɴ sᴀᴍᴇ ʀᴇʟᴇᴀsᴇ ᴅᴀʏ. ᴄᴏɴᴛᴇᴄᴛ ᴀᴅᴍɪɴ - @ɪᴍᴠᴀsᴜᴘᴀʀᴇᴇᴋ</i></b>")
        await asyncio.sleep(600)
        for x in filesarr:
            await x.delete()
